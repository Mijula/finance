...
<head>
	...
	<link href="https://fonts.googleapis.com/css?family=Merriweather:300,400,700|Source+Sans+Pro:400,600" rel="stylesheet">
...
<body>
	...
	<!-- js if lt IE9 -->
	<!-- Important js for IE8 support of HTML5 elements, media queries and psuedos -->
	<!--[if lt IE 9]>
